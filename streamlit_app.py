...
# Streamlit front-end for STL → G‑code exporter
# ------------------------------------------------------------
# This wraps the untouched computational logic from ‘Slicing New - 복사본.py’
# so the app can run on Streamlit Cloud / GitHub.
#
# NOTE:  The numerical algorithms and flow were copy‑pasted
#        without *any* modification – only the UI layer changed.
#
# How to use
# ----------
...
#
# Upload the file together with requirements.txt to GitHub, then
# point Streamlit Cloud to this script (main file: streamlit_app.py).
#
# ------------------------------------------------------------
...
# ------------------------------------------------------------
#  Helper functions (verbatim copies)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
#  G‑code generation core (verbatim logic)
# ------------------------------------------------------------
def generate_gcode(mesh,
                   ...
                   auto_start   = False,
                   m30_on       = False):
    extrusion_k = 0.05  # mm‑per‑unit‑E
    g = ["; *** Generated by STL→G‑code Streamlit Exporter ***",
         "G21", "G90"]
    if e_on:
        g.append("M83")
...
if uploaded is not None:
    # Write to temp file because trimesh expects a path
