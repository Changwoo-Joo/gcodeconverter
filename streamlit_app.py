...
merge_narrow_loops = st.sidebar.checkbox("Merge narrow loops to line (≤1mm gap)", value=False)
...
if uploaded is not None:
    ...
    try:
        ...
        scale_matrix[2, 2] = 1.0000001  # Z만 아주 살짝 확장
    ...
    if st.button("🚀 Generate G‑code"):
        with st.spinner("Processing..."):
            gcode_text = generate_gcode(
                ...
                m30_on = m30_on,
                merge_narrow_loops = merge_narrow_loops
            )
