...
# Streamlit app with simple password gate
# ---------------------------------------
# To change the password, edit the PASSWORD variable below
#
# Computational / slicing logic is identical to the previous version.
# Only the authentication wrapper was added.
#
...
if not st.session_state.authenticated:
    ...
    if login:
        if pwd == PASSWORD:
            ...
            st.success("✅ 로그인 성공! 앱을 새로고침 해주세요 (Ctrl+R 또는 F5)")
                st.stop()
        else:
